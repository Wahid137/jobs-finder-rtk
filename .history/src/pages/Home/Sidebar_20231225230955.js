                ...
                <ul className="space-y-4">
                    <li>
                        ...
                        <ul className="space-y-6 lg:space-y-2 ">
                            <li>
                                <p className="sub-menu cursor-pointer" id="lws-internship-menu">
                                    <i className="fa-solid fa-stop !text-[#FF5757]"></i>
                                    Internship
                                </p>
                            </li>
                            <li>
                                <p className="sub-menu cursor-pointer" id="lws-fulltime-menu">
                                    <i className="fa-solid fa-stop !text-[#FF8A00]"></i>
                                    Full Time
                                </p>
                            </li>
                            <li>
                                <p className="sub-menu cursor-pointer" id="lws-remote-menu">
