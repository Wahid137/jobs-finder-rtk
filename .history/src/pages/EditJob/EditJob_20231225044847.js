            ...
            <div className="max-w-3xl mx-auto">
                <form onSubmit={handleUpdate} className="space-y-6">
                    <div className="fieldContainer">
                        ...
                        <select defaultValue={title} id="lws-JobTitle" name="lwsJobTitle" required onChange={(e) => setTitle(e.target.value)}>
                    ...
                    <div className="fieldContainer">
                        ...
                        <select defaultValue={type} id="lws-JobType" name="lwsJobType" required onChange={(e) => setType(e.target.value)}>
