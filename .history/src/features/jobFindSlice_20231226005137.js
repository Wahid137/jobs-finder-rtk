    ...
    reducers: {
        ...
        sortJobs: (state, action) => {
            switch (action.payload) {
                case "high_low":
                    return state.jobs = state.jobs.sort((a, b) => parseFloat(b.salary) - parseFloat(a.salary));

                case "low_high":
                    return state.jobs = state.jobs.sort((a, b) => parseFloat(a.salary) - parseFloat(b.salary));
